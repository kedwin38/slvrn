...
export const BATCH_EDGES: readonly BatchEdge[] = [
  ...
  E('L2_REVIEW', 'REJECT', 'DRAFT', 'batch:reject', 'L2', 'Rejected and returned to Payment Operations'),
  ...
  // ---- Hold handling -------------------------------------------------------
  E('HELD', 'RELEASE_HOLD', 'SUBMITTED_TO_L2', 'batch:hold', 'L2', 'Hold lifted; returned to review queue'),
